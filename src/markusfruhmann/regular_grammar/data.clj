...
(def t3-non-terminals (helper/generate-non-terminals 15))
(def t4-non-terminals (helper/generate-non-terminals 5))
(def t5-non-terminals (helper/generate-non-terminals 5))
(def t6-non-terminals (helper/generate-non-terminals 6))
(def t7-non-terminals (helper/generate-non-terminals 5))
